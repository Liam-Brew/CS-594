...
public class InitBean {
	...
	private void init() {
		...
		try {
			...
			UserDto moderator = userDtoFactory.createUserDto();
			moderator.setUsername("moderator");
			moderator.setPassword("moderator_password");
			moderator.setName("Moderator");
			moderator.getRoles().add(MODERATOR);
			logger.info("Adding user moderator");
			messageService.addUser(moderator);
